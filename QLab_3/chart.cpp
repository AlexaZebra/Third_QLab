...
void BarChart::createSeries(QList<QPair<QString, qfloat16>> list, std::unique_ptr<QtCharts::QChartView>& ChartView) {
...
void PieChart::createSeries(QList<QPair<QString, qfloat16>> list, std::unique_ptr<QtCharts::QChartView>& ChartView) {
...
void LineChart::createSeries(QList<QPair<QString, qfloat16>> list, std::unique_ptr<QtCharts::QChartView>& ChartView) {
